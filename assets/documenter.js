// NOTE: comment out all the things that are not related to highlighting and math renderings
...
//     $(document).ready(function() {
//         const settings = $('#documenter-settings')
...
//     $(document).ready(function() {
//         const sidebar = $('#documenter > .docs-sidebar')
//         const sidebar_button = $('#documenter-sidebar-button')
...
//         function resize() {
//             const L = parseInt(e.css('max-width'), 10)
//             const L0 = e.width()
//             if(L0 > L) {
//                 const h0 = parseInt(e.css('font-size'), 10)
...
//     $(document).ready(function() {
//         const sidebar = $('#documenter .docs-menu').get(0)
//         const active = $('#documenter .docs-menu .is-active').get(0)
