...
function Base.display(d::JuliaNotebookInlineDisplay, ::MIME{Symbol("image/png")}, x)
    ...
    JSONRPC.send_notification(conn_endpoint[], "notebook/display", Dict{String,Any}("mimetype" => "image/png", "current_request_id" => current_request_id[], "data" => payload))
end
...
function Base.display(d::JuliaNotebookInlineDisplay, ::MIME{Symbol("image/jpeg")}, x)
    ...
    JSONRPC.send_notification(conn_endpoint[], "notebook/display", Dict{String,Any}("mimetype" => "image/jpeg", "current_request_id" => current_request_id[], "data" => payload))
end
...
function Base.display(d::JuliaNotebookInlineDisplay, ::MIME{Symbol("image/svg+xml")}, x)
    ...
    JSONRPC.send_notification(conn_endpoint[], "notebook/display", Dict{String,Any}("mimetype" => "image/svg+xml", "current_request_id" => current_request_id[], "data" => payload))
end
...
function Base.display(d::JuliaNotebookInlineDisplay, ::MIME{Symbol("application/vnd.vegalite.v4+json")}, x)
    ...
    JSONRPC.send_notification(conn_endpoint[], "notebook/display", Dict{String,Any}("mimetype" => "application/vnd.vegalite.v4+json", "current_request_id" => current_request_id[], "data" => payload))
end
...
function Base.display(d::JuliaNotebookInlineDisplay, ::MIME{Symbol("text/html")}, x)
    ...
    JSONRPC.send_notification(conn_endpoint[], "notebook/display", Dict{String,Any}("mimetype" => "text/html", "current_request_id" => current_request_id[], "data" => payload))
end
...
function Base.display(d::JuliaNotebookInlineDisplay, ::MIME{Symbol("text/plain")}, x)
    ...
    JSONRPC.send_notification(conn_endpoint[], "notebook/display", Dict{String,Any}("mimetype" => "text/plain", "current_request_id" => current_request_id[], "data" => payload))
end
...
function Base.display(d::JuliaNotebookInlineDisplay, ::MIME{Symbol("text/markdown")}, x)
    ...
    JSONRPC.send_notification(conn_endpoint[], "notebook/display", Dict{String,Any}("mimetype" => "text/markdown", "current_request_id" => current_request_id[], "data" => payload))
end
