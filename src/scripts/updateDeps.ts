...
async function main() {
    ...
    for (const pkg of ['CodeTracking', 'CoverageTools', 'FilePathsBase', 'JuliaInterpreter', 'LoweredCodeUtils', 'OrderedCollections', 'PackageCompiler', 'Revise', 'Tokenize', 'URIParser', 'CommonMark', 'Compat', 'Crayons', 'DataAPI', 'DataStructures', 'JuliaFormatter', 'URIs']) {
