...
export const requestTypeSetFunctionBreakpoints = new RequestType<DebugProtocol.SetFunctionBreakpointsArguments, SetFunctionBreakpointsResponseArguments, void, void>('setFunctionBreakpoints')
export const requestTypeStackTrace = new RequestType<DebugProtocol.StackTraceArguments, StackTraceResponseArguments, void, void>('stackTrace')
